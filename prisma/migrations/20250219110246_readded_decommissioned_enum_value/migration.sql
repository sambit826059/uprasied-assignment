/*
  ...
  - The values [decomissionedAt] on the enum `GadgetStatusEnum` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "GadgetStatusEnum_new" AS ENUM ('Available', 'Deployed', 'Destroyed', 'Decomissioned');
